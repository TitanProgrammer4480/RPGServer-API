...
def manage_char():
  ...
  if request.method == "GET":
    ...
    if db_exists("chars", data["id"]):
      ...
      char = Character(id=data["id"], name=["charname"], location=data["location"], race=data["race"], specialisation=data["specialisation"], skills=data["skills"], abilities=data["abilities"], quests=data["quests"])
